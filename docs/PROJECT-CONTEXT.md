...
|---|---------|---------------|
| 1 | Controller → только Service; Service → Repository | `docs/06-checklist/COMPLIANCE-AUDIT.md` |
...
**Полный список:** `docs/04-api/REST-ENDPOINTS.md`
...
| Файл | Содержание |
|------|------------|
| `docs/01-business-model/glossary.md` | Глоссарий |
| `docs/02-requirements/use-cases.md` | UC-001, UC-002 |
| `docs/03-architecture/*.md` | PCMEF, Mediator, Foundation |
| `docs/04-api/REST-ENDPOINTS.md` | REST + JWT |
| `docs/05-setup/RIOT-API-SETUP.md` | Настройка Riot |
| `docs/06-checklist/*.md` | Аудит, чеклисты |
| `docs/07-report/POYASNITELNAYA-ZAPISKA.md` | Пояснительная записка (курсовая) |
...
*Последнее обновление: июнь 2026 — mobile с JWT и PUUID-навигацией; тесты с покрытием ≥ 40%.*
